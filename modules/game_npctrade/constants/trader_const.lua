...
controllerNpcTrader.buttonsMerchant = {
    [1] = { id = KeywordButtonIcon.KEYWORDBUTTONICON_YES, text = "Yes" },
    [2] = { id = KeywordButtonIcon.KEYWORDBUTTONICON_NO, text = "No" },
    [3] = { id = KeywordButtonIcon.KEYWORDBUTTONICON_BYE, text = "bye" },
...
controllerNpcTrader.buttonsBanker = {
    [1] = { id = KeywordButtonIcon.KEYWORDBUTTONICON_YES, text = "Yes" },
    [2] = { id = KeywordButtonIcon.KEYWORDBUTTONICON_NO, text = "No" },
    [3] = { id = KeywordButtonIcon.KEYWORDBUTTONICON_BYE, text = "bye" },
    [4] = { id = KeywordButtonIcon.KEYWORDBUTTONICON_WITHDRAW, text = "withdraw" },
    [5] = { id = KeywordButtonIcon.KEYWORDBUTTONICON_DEPOSITALL, text = "deposit all" },
    [6] = { id = KeywordButtonIcon.KEYWORDBUTTONICON_BALANCE, text = "balance" },
}

controllerNpcTrader.buttonsTravel = {
    [1] = { id = KeywordButtonIcon.KEYWORDBUTTONICON_YES, text = "Yes" },
    [2] = { id = KeywordButtonIcon.KEYWORDBUTTONICON_NO, text = "No" },
    [3] = { id = KeywordButtonIcon.KEYWORDBUTTONICON_BYE, text = "bye" },
    [4] = { id = KeywordButtonIcon.KEYWORDBUTTONICON_SAIL, text = "sail" },
}

controllerNpcTrader.BANK_KEYWORDS = {
    "bank", "deposit", "withdraw", "balance", "transfer"
}

controllerNpcTrader.TRAVEL_KEYWORDS = {
    "sail", "passage", "travel", "destination", "route", "trip", "voyage"
}

controllerNpcTrader.TRADE_KEYWORDS = {
    "trade", "sell", "buy", "wares", "offers", "goods", "shop", "merchant", "items", "equipment"
}
